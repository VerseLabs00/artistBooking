      ...
      ══════════════════════════════════════════════════ */}
        <section id="contact-section" className="w-full overflow-hidden">
          ...
          >
            ...
            {/* ── Panel 1: FAQ ─────────────────────────────── */}
            <div ref={faqPanelRef} className="w-1/2 bg-white px-4 sm:px-8 md:px-12 lg:px-16 py-16 sm:py-24" style={{ flexShrink: 0 }}>
            ...
            {/* ── Panel 2: Contact ─────────────────────────── */}
            <div ref={contactPanelRef} className="w-1/2 bg-[#111] px-4 sm:px-8 md:px-12 lg:px-16 py-16 sm:py-24" style={{ flexShrink: 0 }}>
        ...
        FOOTER
      ══════════════════════════════════════════════════ */}
        <footer className="bg-[#0a0a0a] text-white pt-16 sm:pt-24 pb-12">
