    ...
    return (
        <div className="h-screen flex items-center justify-center p-6 overflow-hidden bg-cover bg-center" style={{ backgroundImage: `url(${stage})` }}>
            <div className="relative w-full max-w-6xl h-[90vh] bg-white rounded-2xl shadow-2xl overflow-hidden">
                <div onClick={() => navigate("/verification")} className="absolute top-6 right-8 text-sm font-medium cursor-pointer flex items-center gap-2 z-20">
                    ← Back
                </div>
                <div className="grid grid-cols-2 h-full">
                    ...
                    <div className="relative p-16 flex flex-col justify-center h-full">
                        ...
                        <div className="relative z-10">
                            <h1 className="text-5xl font-semibold leading-tight">Show us<br />your talent</h1>
                            <p className="mt-6 max-w-md leading-relaxed">Add your best performances — videos, audio tracks, and social profiles so we can verify your work as an artist.</p>
                    ...
                    <div className="p-16 h-full overflow-y-auto scroll-smooth">
                        ...
                        <h2 className="text-xl font-semibold mb-2">Video Performances <span className="text-red-500">*</span></h2>
                        ...
                        <div onClick={() => fileRef.current?.click()}
                            className={`border-2 border-dashed rounded-2xl h-44 flex flex-col items-center justify-center text-gray-500 hover:border-red-500 transition cursor-pointer mb-6 ${mediaFile ? "border-green-400" : ""}`}>
