    ...
    return (
        <div className="min-h-screen flex flex-col bg-cover bg-center font-['Fraunces']" style={{ backgroundImage: `url(${stage})`, fontFamily: "'Fraunces', serif" }}>
            ...
            <div className="flex-grow flex items-center justify-center p-4">
                <div className="relative overflow-hidden bg-white/90 backdrop-blur-xl border border-white/40 w-full max-w-4xl rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.3)] grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-6 lg:p-10">
